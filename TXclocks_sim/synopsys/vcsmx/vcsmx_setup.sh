...
# ACDS 17.1 590 linux 2019.09.17.12:41:54
...
# ----------------------------------------
# If TXclocks is one of several IP cores in your
...
TOP_LEVEL_NAME="TXclocks"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/jonathan/intelFPGA_lite/17.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/TXclocks.vo"
fi
