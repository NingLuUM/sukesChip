...
# ACDS 17.1 590 linux 2019.09.18.09:28:46
...
# ----------------------------------------
# If ADCclock is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ADCclock.vo"
fi
