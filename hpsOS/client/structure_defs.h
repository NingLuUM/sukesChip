...
typedef struct SOCKprimitive_{
	int fd;
	struct{
		uint8_t isEnetCommSock : 1;
		uint8_t isEnetRecvLargeBuffer : 1;
		uint8_t isInterruptTx : 1;
		uint8_t isInterruptRcv : 1;
		uint8_t isIpcTx : 1;
		uint8_t isIpcRx : 1;
	} type;
	void *parent;	
...
typedef struct ENETsock_{
    ...
    void (*connectInterrupt)(ENETsock **, char *, int);
    void (*disconnectInterrupt)(ENETsock **);
    void (*addPollSock)(ENETsock **, int);
    void (*connectPollSock)(ENETsock **, int);
    void (*disconnectSock)(ENETsock **, int);
    void (*setPacketSize)(ENETsock *, uint32_t);
    void (*sendAcqdData)(ENETsock **, struct RCVsys_ *, char *, int);
} ENETsock;
